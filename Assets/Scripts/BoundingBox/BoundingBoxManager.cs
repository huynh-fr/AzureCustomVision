...
public class BoundingBoxManager : MonoBehaviour {
    ...
    /// </summary>
    public void MakeBoundingBoxInteractible(GameObject obj, BoundingBox.FlattenModeEnum flattenedAxis = default(BoundingBox.FlattenModeEnum))
    {
        ...
        bbRig.flattenedAxis = flattenedAxis;
